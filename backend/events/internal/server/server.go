...
type Options struct {
	...
	EventsService pb.EventsServiceServer `option:"mandatory" validate:"required"`
}
...
type Server struct {
	...
	production    bool
	addr          string
	EventsService pb.EventsServiceServer
}
...
func (s *Server) Run(ctx context.Context) error {
	...
	pb.RegisterEventsServiceServer(s.srv, s.EventsService)
