...
require (
	github.com/Slava02/SaintDiego/backend/clients v0.0.0-20250425142917-915a210a0acd
...
require (
	...
	github.com/Slava02/SaintDiego/backend/schedule v0.0.0-20250507154402-e2fbc539c258 // indirect
