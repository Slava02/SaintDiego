...
func (o *Options) Validate() error {
	...
	errs.Add(errors461e464ebed9.NewValidationError("tracer", _validate_Options_tracer(o)))
	return errs.AsError()
}
...
func _validate_Options_tracer(o *Options) error {
	if err := validator461e464ebed9.GetValidatorFor(o).Var(o.tracer, "required"); err != nil {
		return fmt461e464ebed9.Errorf("field `tracer` did not pass the test: %w", err)
	}
	return nil
}
