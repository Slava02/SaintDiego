...
import (
	...
	"github.com/Slava02/SaintDiego/backend/auth/internal/server"
	...
	v1 "github.com/Slava02/SaintDiego/backend/auth/internal/server/v1"
)
...
func run() error {
	...
	if err != nil {
		return fmt.Errorf("init auth service: %v", err)
	}
