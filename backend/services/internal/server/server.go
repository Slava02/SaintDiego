...
import (
	...
	"github.com/Slava02/SaintDiego/backend/services/internal/interceptors"
...
type Options struct {
	...
	ServicesService pb.ServicesServiceServer `option:"mandatory" validate:"required"`
}
...
func New(opts Options) (*Server, error) {
	...
	return &Server{
		...
		ServicesService: opts.ServicesService,
	}, nil
}
...
func (s *Server) Run(ctx context.Context) error {
	...
	pb.RegisterServicesServiceServer(s.srv, s.ServicesService)
