...
const (
	...
	ScheduleService_GetServices_FullMethodName      = "/schedule.ScheduleService/GetServices"
	ScheduleService_GetServiceById_FullMethodName   = "/schedule.ScheduleService/GetServiceById"
)
