...
//
//	mockgen -source=keycloak_token_auth.go -destination=mocks/introspector_mock.gen.go -package=middlewaresmocks Introspector
//
...
func (mr *MockIntrospectorMockRecorder) IntrospectToken(ctx, token any) *gomock.Call {
