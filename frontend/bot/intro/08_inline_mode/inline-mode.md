...
![Пример работы бота @imdb в инлайн-режиме](inline_mode/inline_demo.png)
...
![тип InlineQueryResultArticle](inline_mode/inline_articles.jpg)
...
![тип InlineQueryResultPhoto](inline_mode/inline_pictures.png)
...
![Кнопка switch_pm](inline_mode/switch_pm_button.png)
...
![Содержимое объекта InlineQueryResultArticle](inline_mode/article_content.png "Содержимое объекта InlineQueryResultArticle")
...
![Просмотр ссылок](inline_mode/our_links_result.png "Просмотр ссылок")

При нажатии получается вот такое красивое сообщение:

![Результат в чате](inline_mode/our_links_result_in_chat.png "Результат в чате")
...
![Отображение картинок в инлайн-режиме](inline_mode/our_images_result.png "Отображение картинок в инлайн-режиме")
...
![Кнопка switch_inline_query_current_chat](inline_mode/cmd_delete.png "Кнопка switch_inline_query_current_chat")
...
![Пример работы бота @imdb в инлайн-режиме](inline_mode/botfather_inline_feedback.png "Пример работы бота @imdb в инлайн-режиме")
