...
![Два вида кнопок](buttons/l03_1.png)
...
![Очень большие обычные кнопки](buttons/l03_2.png)
...
![Кнопки в один ряд](buttons/l03_3.png)
...
![Реакция на нажатие кнопок](buttons/l03_4.png)
...
![Результат работы сборщика кнопок](buttons/reply_builder.png)
...
![Специальные обычные кнопки](buttons/special_buttons.png)
...
![Реакция на нажатие колбэк-кнопки](buttons/l03_5.png)
...
![Всплывающее окно при нажатии на колбэк-кнопку](buttons/l03_6.png)
...
![Всё работает?](buttons/l03_7.png)
...
![Ошибка BadRequest при определённых обстоятельствах](buttons/l03_8.png)
...
![Фабрика колбэков](buttons/callback_factory.png)
