...
![Работа фильтра в группе](filters-and-middlewares/group_filter.png)
...
![Перечисляем вытащенные юзернеймы](filters-and-middlewares/data_propagation_in_filter.png)
...
![«луковица» из мидлварей](filters-and-middlewares/middlewares_structure.png)
...
![У кого-то месяц счастливый, а у кого-то не очень](filters-and-middlewares/happymonth.png)
