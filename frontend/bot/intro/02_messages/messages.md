...
![Hello world с разным форматированием](messages/l02_1.png)
...
![Настройка типа разметки по умолчанию](messages/l02_2.png)
...
![Работа команды /hello](messages/cmd_hello_before.png)
...
![Работа команды /hello после фиксов](messages/cmd_hello_after.png)
...
![Продвинутый пример](messages/advanced_example.png)
...
![Добавленный текст (неудачная попытка)](messages/keep_formatting_bad.png)
...
![Добавленный текст (успех)](messages/keep_formatting_good.png)
...
![Парсинг entities](messages/parse_entities.png)
...
![Аргументы команд](messages/command_args.png)
...
![Флуд командами](messages/commands_flood.png)
...
![Кастомные префиксы](messages/command_custom_prefix.png)
...
![Примеры диплинков](messages/deeplinks.png)
...
Результат: 
![Примеры предпросмотров ссылок](messages/link_preview_options.png)
...
![подпись над анимацией](messages/caption_above_media.jpg)
...
![Результат работы билдера](messages/media_group_builder.png)
...
![Сервисные сообщения](messages/service_messages.png)
...
![Добавлены несколько юзеров](messages/multiple_add.png)
...
![Изображение со скрытой ссылкой](messages/hidden_link.png)
