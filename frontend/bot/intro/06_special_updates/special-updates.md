...
![Пользователь заблокировал бота](special-updates/my_chat_member-blocked.png)
...
![Пользователь разблокировал бота](special-updates/my_chat_member-unblocked.png)
...
![type:video](special-updates/my_chat_member_video.mp4)
...
![конвертация группы в супергруппу](special-updates/group_supergroup.png)
