...
![Команда /test2 не работает](quickstart/l01_1.jpg)
...
Снова запустим бота:  
![Обе команды работают](quickstart/l01_2.jpg)
...
```
![Разница между message.answer() и message.reply()](quickstart/l01_3.jpg)
...
![Аргумент mylist может быть изменён между вызовами](quickstart/extra-args.png)
